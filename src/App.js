    ...
    async function init() {
      ...
      if (window.ethereum) {
        ...
        try {
          ...
          const deployedNetwork = MultiSigWalletContract.networks[networkId];
          const instance = new web3Instance.eth.Contract(
            MultiSigWalletContract.abi,
            deployedNetwork && deployedNetwork.address,
          );
          setContract(instance);

          // Load pending transactions
          const pending = await instance.methods.getPendingTransactions().call();
